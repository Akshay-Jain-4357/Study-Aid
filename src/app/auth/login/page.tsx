...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden grid-bg" style={{ background: 'var(--bg-base)' }}>
      {/* Background Blobs (matching our premium design system) */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-72 h-72 rounded-full blur-[100px] opacity-15" style={{ background: '#6366f1' }} />
        <div className="absolute bottom-1/3 left-1/3 w-56 h-56 rounded-full blur-[80px] opacity-10" style={{ background: '#8b5cf6' }} />
      </div>
